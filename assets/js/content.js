...
window.DEFAULT_CONTENT = {
  ...
  projecten: [
    ...
    },
    {
      ...
      type: "YouTube Kanaal / In opdracht",
      beschrijving:
  ...
  opleidingen: [
    { titel: "Masterclass Audio", instituut: "Quindo Medialab" },
    { titel: "Masterclass Live Streaming", instituut: "Quindo Medialab" },
    { titel: "Masterclass Green Screen", instituut: "Quindo Medialab" }
  ],

  contact: {
    titel: "Neem contact op",
    tekst:
      "Een video nodig of een thumbnail voor je volgende banger? Of gewoon een vraag? Laat hieronder een bericht achter.",
